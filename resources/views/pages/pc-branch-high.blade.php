...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/pc-branch.css') }}">
</head>
<body>
      ...
      <div class="container-fluid nav-content">
        ...
        <div class="collapse navbar-collapse navbar-collapse-sorting" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('comment') }}" style="color: #000000;">Comments</a>
            </li>
          </ul>
          <!-- Tombol Login/Logout -->
          @guest
              ...
              <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="Image\pc-branch\high-green\end6-scaled.png" class="d-block w-50 carousel-align carousel-design" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="Image\pc-branch\high-green\end8-scaled.png" class="d-block w-50 carousel-align carousel-design" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="Image\pc-branch\high-green\end11-scaled.png" class="d-block w-50 carousel-align carousel-design" alt="...">
                  </div>
                </div>
